...
max_abs_evals_eq = zeros(Ngvals,1);
...
save(fname,"gvals","u1_eq","u2_eq","prey_eq","u1_loop_min",...
...
if graphix_flag == 1
    ...
    legend(hand(1:3:7))
    title(sprintf("tau = %.2f",tau));
    savefig(sprintf("Figures/fig_tau%.4f.fig",tau))
end
